...
function testShowGffDoc() {
 ...
 function showGffDoc(doc,subclass) {
	 ...
	 var content='<div id="gff_'+doc['id']+'" class="document'+subclass+'">';
 ...
 function showPdbDoc(doc,subclass) {
     var content='<div id="pdb_'+doc['id']+'" class="document'+subclass+'">';
 ...
 function detailsLink(doc) {
	var content='<img  onclick="showDetails(\''+doc["seqid"]+'\',\''+ doc["stream_content_type"] +'\',\''+ doc["stream_name"]  +'\',\''+ doc["file"]  +'\')" title="Show details" alt="Show details" src="images/ihelp.png" class="icon"/>';
	return content;
 }
